...
/*package*/ class WildcardedClass_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public WildcardedClass_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_4ef5o6_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    if (nodeCondition_4ef5o6_a0a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    if (nodeCondition_4ef5o6_a1a()) {
      editorCell.addEditorCell(createProperty_0());
    }
    if (nodeCondition_4ef5o6_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    if (nodeCondition_4ef5o6_a3a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    return editorCell;
  }
  private boolean nodeCondition_4ef5o6_a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.usePreWildcard$1XYK);
  }
  private boolean nodeCondition_4ef5o6_a1a() {
    return !(SPropertyOperations.getBoolean(myNode, PROPS.useGeneralWildcard$236F));
  }
  private boolean nodeCondition_4ef5o6_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.usePostWildcard$1XZI);
  }
  private boolean nodeCondition_4ef5o6_a3a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.useGeneralWildcard$236F);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "*");
    editorCell.setCellId("Constant_4ef5o6_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.class$YEmF;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("Class");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "*");
    editorCell.setCellId("Constant_4ef5o6_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "*");
    editorCell.setCellId("Constant_4ef5o6_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
